/*
In this activity, we will be converting date strings like "2017/12/02", into more English 
friendly date strings like December 2nd, 2017.
...
const talkingCalendar = function (date) {
  ...
  let day = parseInt(dateSplitted[2]);
  let month = months[parseInt(dateSplitted[1] - 1)];

return `${month} ${day}${day === 1 ? "st" : day === 2 ? "nd" : day === 3 ? "rd" : "th"}, ${dateSplitted[0]}`
};
