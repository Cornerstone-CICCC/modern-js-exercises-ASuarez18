...
inflatable attractions, but they have no clue how to much blow them up. Each attraction needs to be pumped to 
a precise volume to achieve maximum festival fun!

The attractions are each made up of a combination of several different shapes: 
cones, spheres and prisms. For example, the giant inflatable duck is made up of two spheres (the body and head) 
and a cone (the beak) 🦆.
...
const sphereVolume = (radius) => (4 / 3) * PI * (radius * radius * radius);

console.log(4186 < sphereVolume(10) && sphereVolume(10) < 4189); //true

const coneVolume = (radius, height) => (1 / 3) * PI * (radius * radius) * height;

console.log(45 < coneVolume(3, 5) && coneVolume(3, 5) < 49); //true

const prismVolume = (height, width, depth) => (width * depth) * height;
